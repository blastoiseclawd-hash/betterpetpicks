...
// Purpose: Beginner support page for the Cat Litter cluster

export const howMuchCatLitterToUseContent = {
  title: "How Much Cat Litter to Use",
  description:
    "How much cat litter to put in the litter box: the right depth, how often to top off, and what happens when you use too much or too little. Simple guide for every litter type.",
  ...
  sections: [
    {
      ...
      body: `The answer depends on the litter type, but the range is narrow.
...
**Problem 3: Overflow and scatter.** More litter in the box means more litter available to be kicked out. Cats that dig vigorously will scatter the excess onto the floor, which defeats the purpose of a contained litter area. This is especially true for top-entry boxes where the cat launches litter upward during digging.`,
    },
    {
      ...
      body: `Under-filling is the more common problem and the one that causes real behavioral issues.
...
**Frequency:** Most single-cat homes need to top off every 2 to 3 days with daily scooping. Multi-cat homes may need to top off daily. If you are topping off more than once a day, the box is too small or you need a different litter with better clumping efficiency.`,
    ...
    {
      id: "monthly-usage",
      heading: "How much cat litter you actually go through per month",
      body: `Most guides give you a number and move on. Here is a more honest breakdown based on typical scooping and replacement patterns.
