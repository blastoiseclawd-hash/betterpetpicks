...
// Desk: Pet Cleanup
// Primary keyword: how to remove pet hair from clothes (Vol 4,400, KD 3, TP 3,800)
...
export const howToRemovePetHairFromClothesContent = {
  ...
  description:
    "How to get pet hair off clothes before you leave the house, in the dryer, and in the wash. Covers lint rollers, dryer tricks, fabric-specific methods, and daily prevention habits.",
  ...
  sections: [
    {
      ...
      heading: "Lint roller technique that actually clears the fabric",
      body: `A lint roller is the fastest tool for pet hair on clothes, but most people use it wrong. Rolling in random directions spreads hair around instead of lifting it off.
...
Clean the lint trap before and after the cycle. A full trap cannot catch hair. If the trap is coated before you start, the dryer just moves hair around instead of removing it.`,
      steps: [
        ...
        {
          name: "Load the hairy clothes loosely into the dryer",
          description:
        ...
        {
          name: "Add a dryer sheet or wool dryer ball",
          description:
        ...
        {
          name: "Run on low heat for 10 minutes",
          description:
        ...
        {
          name: "Clean the lint trap again and inspect",
          description:
...
**Black clothing** shows every strand regardless of removal method. The dryer pre-cycle plus a lint roller pass before you walk out is the minimum routine. Storing black clothes in a separate section of the closet, away from pet-accessible areas, makes the biggest difference.`,
    },
    {
      ...
      body: `Sometimes you notice pet hair on your clothes at the office, in a car, or somewhere without a lint roller. These are not ideal methods, but they work in a pinch.
...
**Keep a lint roller by the door.** A final pass before you leave catches what you missed. This does not prevent hair from getting on clothes, but it ensures you do not walk out wearing it.`,
  ...
  faqs: [
    ...
    {
      question: "Do wool dryer balls help with pet hair?",
      answer:
