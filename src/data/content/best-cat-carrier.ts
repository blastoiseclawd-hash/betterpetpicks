...
export const bestCatCarrierGuide = {
  ...
  displayNames: {
    ...
    "petmate-two-door-top-load": "Petmate Two-Door Top Load",
    "henkelion-cat-carrier-expandable": "Henkelion TSA Soft-Sided",
    "sportpet-foldable-cat-carrier": "SportPet Foldable Carrier",
    "sleepypod-air-carrier": "Sleepypod Air",
  },

  badges: {
    "sherpa-original-deluxe": "Best Airline Approved",
    "petmate-two-door-top-load": "Best for Vet Visits",
    "henkelion-cat-carrier-expandable": "Best Budget Airline",
    "sportpet-foldable-cat-carrier": "Best Collapsible",
    "sleepypod-air-carrier": "Best Premium",
  },
  ...
  comparisonColumns: [
    ...
    { key: "type", label: "Type" },
    { key: "airlineApproved", label: "Airline Approved" },
    { key: "keyFeature", label: "Key Feature" },
  ],

  comparisonTable: [
    {
      badge: "Best Airline Approved",
    ...
    {
      badge: "Best for Vet Visits",
      name: "Petmate Two-Door Top Load",
      price: "$53.95",
      goodFor: "Vet trips, car travel",
      type: "Hard-sided",
      airlineApproved: "No",
      keyFeature: "Wide top door skips the leg-lock struggle",
      slug: "petmate-two-door-top-load",
    },
    {
      badge: "Best Budget Airline",
      name: "Henkelion TSA Carrier",
      price: "$28.98",
    ...
    },
    {
      ...
      name: "SportPet X-Large Foldable",
      price: "$41.70",
      goodFor: "Larger cats, limited storage",
      type: "Hard-sided foldable",
      airlineApproved: "No",
      keyFeature: "Folds flat, holds cats up to 35 lb",
    ...
    },
    {
      ...
      name: "Sleepypod Air",
      price: "$199.99",
      goodFor: "Frequent flyers, long car trips",
      type: "Soft-sided premium",
      airlineApproved: "Yes",
      keyFeature: "CPS crash-tested ballistic nylon",
...
The one thing to watch is the zippers. Under a panicking cat, a zipper that was not fully clicked into the locking tab can separate. The locking tabs are built into the frame for exactly this reason. Use them every time. Owner reports on r/CatAdvice about Sherpa zipper failures almost always end with a version of "I forgot to flip the locking tab."`,
      pros: [
        ...
        "Top and side doors give two loading options for different situations",
      ],
      cons: [
        "Zippers can separate under stress if locking tabs are not engaged",
...
The fleece pad inside is removable and machine washable. The mesh ventilation panels are adequate but smaller than the Sherpa's, so on a warm day the inside runs a little warmer. Worth noting if you live somewhere without reliable air conditioning in the car.`,
      pros: [
        ...
        "Removable fleece pad is washable and provides comfort on hard surfaces",
      ],
      cons: [
        "Build quality and hardware are visibly lighter than premium carriers",
