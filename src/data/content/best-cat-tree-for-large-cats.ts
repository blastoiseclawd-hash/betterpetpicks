...
export const bestCatTreeForLargeCatsGuide = {
  ...
  description:
    "Best cat trees for large cats compared on weight capacity, post diameter, base stability, and platform width. The FEANDREA Large XL leads for cats 15-25 pounds.",
...
Measure your cat from chest to rump while lying on its side. Add 3-4 inches. That is the minimum platform width for comfortable resting. For most large domestic breeds, this works out to 15-16 inches. For Maine Coons and Ragdolls, 17-18 inches is more realistic.
...
Placement also helps. A cat tree in a corner with two walls already has more stability than a tree in open floor space. The walls prevent tipping in two directions. Combine corner placement with one L-bracket on the third open side and the tree is secure against all reasonable forces.`,
  ...
  lastUpdatedNote:
    "Last updated April 16, 2026. Product lineup checked against current Amazon availability, weight and dimension specs verified at time of publish.",
};
