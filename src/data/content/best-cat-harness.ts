...
Weigh your cat on a home scale if the listing gives weight ranges instead of measurements. Weight ranges are less reliable than chest girth, but they are better than guessing.`,
      },
      {
        ...
        body: `Most cat harness failures happen on the first outdoor walk because the owner skipped indoor training. A cat that goes from zero harness experience to a front yard in one step will panic, freeze, or escape.

Put the harness on indoors for 5-10 minutes a day for the first week. Let the cat walk around the house wearing it. Do not attach a leash yet. The goal is for the cat to move normally while wearing the harness without flopping, rolling, or freezing.
...
After 2-3 weeks of indoor practice, try the first outdoor session in a quiet, enclosed area. A fenced yard or a quiet patio is ideal. Busy sidewalks, other animals, and loud traffic are all second-month outings, not first-day outings.`,
      },
    ],
  },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Most cats need 2-3 weeks of daily indoor practice before they are comfortable enough for outdoor walks. Start with the harness alone for the first week, add a trailing leash in week two, and hold the leash loosely indoors in week three. Some cats adapt faster, some slower. Forcing the pace causes setbacks.",
    },
    {
