 ...
 * Research doc: data/research/best-pet-hair-remover.md (COMPLETE)
 */
...
export const bestPetHairRemoverGuide = {
  ...
  description:
    "Best pet hair removers compared by surface type. The ChomChom Roller leads for furniture, the Uproot Cleaner Pro wins on carpet, and no single tool handles every surface.",
  ...
  badges: {
    ...
    "uproot-cleaner-pro": "Best for Carpet & Rugs",
  ...
  curatedSpecs: {
    ...
    "uproot-cleaner-pro": {
      ...
      "Key feature": "Micro-edge bristles scrape embedded hair from fibers",
    },
    "furemover-extendable-broom": {
      Type: "Rubber broom",
    ...
    "scotch-brite-large-lint-roller": {
      ...
      "Best surface": "Clothing, any fabric — grab-and-go",
  ...
  comparisonTable: [
    ...
    },
    {
      ...
      name: "Lilly Brush",
      price: "$12.95",
      goodFor: "Car interiors & tight spaces",
      type: "Handheld scraper",
      reusable: "Yes",
  ...
  reviews: {
    "chomchom-roller-reusable": {
      ...
      body: `Pet hair on a couch is a different problem than pet hair on a carpet. The ChomChom solves the couch problem.
...
At $24.99, the zero-refill design means the only ongoing cost is your effort. A household spending $10-15 per month on disposable lint roller sheets recoups the investment within two to three months.`,
    ...
    "uproot-cleaner-pro": {
      ...
      body: `The Uproot Cleaner Pro shows you how much pet hair your vacuum actually misses.
...
At $19.99, it is the cheapest reusable tool on this page that handles carpet effectively.`,
    ...
    "furemover-extendable-broom": {
      ...
      body: `The Uproot Cleaner Pro handles one rug at a time. The FURemover handles the entire living room.
...
At $12.99 it costs less than a single replacement vacuum filter.`,
    ...
    "lilly-brush-be-forever-fur": {
      ...
      body: `Auto detailing professionals adopted the Lilly Brush because car upholstery holds pet hair more aggressively than home furniture. The fabric weave in car seats is tighter. The hair embeds deeper. Rolling and adhesive tools fail here.
...
Detailers on Reddit confirm it outperforms every other tool inside a vehicle. Keep it in the glove box.`,
    ...
    "scotch-brite-large-lint-roller": {
      ...
      body: `Every other tool on this page requires a technique. The Scotch-Brite requires none.
