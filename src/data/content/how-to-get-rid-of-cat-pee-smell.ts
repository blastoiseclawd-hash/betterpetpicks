...
export const howToGetRidOfCatPeeSmellContent = {
  ...
  secondaryKeywords: [
    ...
    "get cat pee smell out of clothes",
    "cat urine odor removal",
    "why does cat pee smell so bad",
    "blacklight cat urine",
  ],
  ...
  heroImage: {
    ...
    alt: "Spray bottle of enzymatic cleaner, folded towels, and a UV blacklight flashlight on a clean surface with a tabby cat sitting nearby",
  },
  ...
  sections: [
    {
      id: "why-cat-pee-smells",
      heading: "Why cat pee smells so bad and keeps coming back",
      body: `Cat urine is not just ammonia. It contains felinine, a sulfur-based amino acid that only cats produce. When bacteria break down urine, they release thiols. Those are the same compounds in skunk spray. That is why cat pee smells worse than dog pee or human urine.
...
One type of cleaner breaks down uric acid. Everything else is temporary.`,
    ...
    {
      id: "find-every-spot",
      heading: "Find every spot first",
      body: `Before you start cleaning, find every affected area. Dried urine stains are often invisible to the naked eye, especially on carpet, behind furniture, and along baseboards.
...
If you find more spots than expected, that is normal. One accident often means several. The cleanup process is the same for each one, but you need to treat every spot or the cycle continues.`,
      image: {
        src: "/images/guides/how-to-get-rid-of-cat-pee-smell/02-blacklight.png",
        alt: "UV blacklight flashlight revealing glowing cat urine spots along a baseboard with painter's tape nearby for marking",
        caption:
          "Cat urine fluoresces under UV light. Scan in complete darkness for the clearest results.",
      },
    },
    {
      id: "the-right-cleaner",
      heading: "The only cleaner that actually works",
      body: `Enzymatic cleaners contain bacterial cultures that produce enzymes specifically designed to break down uric acid. The enzymes convert uric acid into carbon dioxide and ammonia gas. Both evaporate. The uric acid is gone permanently. No reactivation, no phantom smell, no cat returning to the spot.
...
**The application matters as much as the product.** Most people spray enzymatic cleaner on a stain and wipe it up. That is not enough. The cleaner must reach the same depth the urine reached. On carpet, that means soaking through the fibers into the padding. On a mattress, that means saturating the foam. Spray-and-wipe does not get deep enough.`,
      image: {
        src: "/images/guides/how-to-get-rid-of-cat-pee-smell/03-cleanup-process.png",
        alt: "Step-by-step cleanup process showing paper towels for blotting, enzymatic cleaner being poured, and a timer for the 15-minute soak",
        caption:
          "The correct order: blot first, soak with enzymatic cleaner, wait at least 15 minutes, then blot again.",
      },
      steps: [
        {
          name: "Blot up as much urine as possible",
          description:
        ...
        {
          name: "Soak the area with enzymatic cleaner",
          description:
    ...
    {
      id: "surface-by-surface",
      heading: "Surface-by-surface guide",
      body: `The core method is the same everywhere: blot, soak with enzymatic cleaner, wait, air dry. But each surface has quirks that change how you apply it.`,
      image: {
        src: "/images/guides/how-to-get-rid-of-cat-pee-smell/04-surface-guide.png",
        alt: "Cross-section comparison showing how cat urine penetrates carpet with padding, hardwood floor, and mattress foam differently",
        caption:
      ...
      steps: [
        ...
        {
          name: "Upholstery and couch cushions",
          description:
    ...
    {
      id: "mistakes",
      heading: "Mistakes that make the smell worse",
      body: `Some of the most common cleanup methods actively make cat urine smell harder to remove. If you have tried cleaning a spot and the smell got worse, one of these is probably the reason.
...
**Using expired cleaner.** The enzymes in enzymatic cleaners are living bacterial cultures. They degrade over time, especially after the bottle has been opened. Check the expiration date. If the bottle has been open for more than a year, replace it.`,
      image: {
        src: "/images/guides/how-to-get-rid-of-cat-pee-smell/05-mistakes.png",
        alt: "Comparison panel showing the correct approach of blotting with cold water versus the incorrect approach of using a steam cleaner on cat urine",
        caption:
    ...
    },
    {
      ...
      body: `Sometimes the right answer is replacement, not more cleaning.
...
The goal is not perfection on the first pass. It is breaking the cycle. Clean every spot you can find, replace what is too far gone, and address why the cat is not using the litter box.`,
    },
    {
      ...
      body: `Cleaning solves the symptom. Preventing future accidents solves the problem. If a cat pees outside the litter box once, there is usually a reason.
...
A litter box that is clean, filled with the right litter, placed in a calm spot, and available in the right quantity eliminates most of the behavioral reasons cats avoid it. Getting the litter right is the foundation.`,
  ...
  faqs: [
    {
      question: "Does vinegar get rid of cat pee smell?",
      answer:
    ...
    {
      question: "How long does cat pee smell last?",
      answer:
    ...
    {
      question: "Can you use bleach on cat pee?",
      answer:
    ...
    {
      question: "Why does my house still smell like cat pee after cleaning?",
      answer:
    ...
    {
      question: "Does baking soda remove cat urine odor?",
      answer:
    ...
    {
      question: "Why does my cat keep peeing in the same spot?",
      answer:
  ...
  relatedLinks: [
    ...
    {
      href: "/best-non-tracking-cat-litter",
      title: "Best Non-Tracking Cat Litter",
    },
