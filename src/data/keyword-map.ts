...
export const pageTargets: PageTarget[] = [
  ...
  // --- Cluster: Pet Hair Cleanup (continued) ---
  {
    ...
    primaryVolume: 1000,
    primaryKd: 2,
    secondaryKeywords: ["pet hair remover", "best pet hair remover for furniture", "reusable pet hair remover"],
  ...
  },
  {
    ...
    primaryVolume: 8700,
    primaryKd: 0,
    secondaryKeywords: ["remove pet hair from couch", "get pet hair off couch", "pet hair on furniture"],
    authorSlug: "pet-cleanup-desk",
    audienceProfile: "Dust-Sensitive Space Manager",
    primaryAvatar: "Clean-Space Manager",
    priority: 1,
  ...
  },
  {
    ...
    primaryVolume: 150,
    primaryKd: 0,
    secondaryKeywords: ["remove pet hair from clothes", "get pet hair off clothes", "pet hair on laundry"],
    authorSlug: "pet-cleanup-desk",
    audienceProfile: "Dust-Sensitive Space Manager",
    primaryAvatar: "Clean-Space Manager",
    priority: 2,
  ...
  },
  {
    ...
    primaryVolume: 200,
    primaryKd: 0,
    secondaryKeywords: ["cat scratching post training", "cat won't use scratching post", "redirect cat scratching"],
    authorSlug: "cat-care-essentials-desk",
    audienceProfile: "Low-Mess Starter",
    primaryAvatar: "Practical Starter",
    priority: 2,
  ...
  },
  {
    ...
    primaryVolume: 350,
    primaryKd: 2,
    secondaryKeywords: ["how often should you change cat litter", "cat litter change schedule", "when to replace cat litter"],
    authorSlug: "cat-care-essentials-desk",
    audienceProfile: "Low-Mess Starter",
    primaryAvatar: "Practical Starter",
    priority: 2,
  ...
  },
  {
    ...
    primaryVolume: 1000,
    primaryKd: 2,
    secondaryKeywords: ["cat pee carpet cleaner", "remove cat urine from carpet", "cat pee stain carpet"],
    authorSlug: "cat-care-essentials-desk",
    audienceProfile: "Low-Mess Starter",
    primaryAvatar: "Practical Starter",
    priority: 2,
