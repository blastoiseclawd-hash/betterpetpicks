...
import { lowTrackingCatLitterGuide } from "@/data/content/low-tracking-cat-litter";
import { generatePageMetadata } from "@/lib/metadata";
import { HubPage } from "@/components/pages/hub-page";

const content = lowTrackingCatLitterGuide;
...
export default function LowTrackingCatLitterPage() {
