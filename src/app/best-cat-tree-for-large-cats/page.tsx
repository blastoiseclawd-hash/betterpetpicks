...
import { bestCatTreeForLargeCatsGuide } from "@/data/content/best-cat-tree-for-large-cats";
import { generatePageMetadata } from "@/lib/metadata";
import { HubPage } from "@/components/pages/hub-page";

const content = bestCatTreeForLargeCatsGuide;
...
export default function BestCatTreeForLargeCatsPage() {
  ...
  return (
    <HubPage
      ...
      relatedLinks={[
        { href: "/best-cat-tree", title: "Best Cat Trees" },
