...
import { bestIndestructibleDogBedGuide } from "@/data/content/best-indestructible-dog-bed";
import { generatePageMetadata } from "@/lib/metadata";
import { HubPage } from "@/components/pages/hub-page";

const content = bestIndestructibleDogBedGuide;
...
export default function BestIndestructibleDogBedPage() {
  ...
  return (
    <HubPage
      ...
      relatedLinks={[
        { href: "/best-chew-proof-dog-bed", title: "Best Chew-Proof Dog Beds" },
        { href: "/best-cooling-dog-bed", title: "Best Cooling Dog Beds" },
