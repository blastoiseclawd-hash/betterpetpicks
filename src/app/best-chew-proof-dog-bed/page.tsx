...
import { bestChewProofDogBedGuide } from "@/data/content/best-chew-proof-dog-bed";
import { generatePageMetadata } from "@/lib/metadata";
import { HubPage } from "@/components/pages/hub-page";

const content = bestChewProofDogBedGuide;
...
export default function BestChewProofDogBedPage() {
  ...
  return (
    <HubPage
      ...
      relatedLinks={[
        { href: "/best-indestructible-dog-bed", title: "Best Indestructible Dog Beds" },
