...
import { bestCatTreeGuide } from "@/data/content/best-cat-tree";
import { generatePageMetadata } from "@/lib/metadata";
import { HubPage } from "@/components/pages/hub-page";

const content = bestCatTreeGuide;
...
export default function BestCatTreePage() {
  ...
  return (
    <HubPage
      ...
      relatedLinks={[
        { href: "/best-cat-tree-for-large-cats", title: "Best Cat Trees for Large Cats" },
        { href: "/how-to-get-cat-to-use-scratching-post", title: "How to Get a Cat to Use a Scratching Post" },
        { href: "/best-cat-harness", title: "Best Cat Harnesses" },
        { href: "/best-cat-carrier", title: "Best Cat Carriers" },
